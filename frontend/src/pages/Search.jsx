...
function Search() {
  ...
  return (
    <div style={{ width: '412px', height: '917px', padding: '0' }} className="flex flex-col">
      ...
      <Flex alignItems={'center'} padding={"10px"} className="w-full">
  <Autocomplete className="w-[70%]">
    <Input ref={originRef} placeholder='Enter your location' size='lg' height="40px" />
  </Autocomplete>
